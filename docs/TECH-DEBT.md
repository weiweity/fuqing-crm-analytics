...
**最后更新**: 2026-06-24 (Sprint 104 删 /visitor 路由别名 (留尾治理 sprint 模式, 跟 Sprint 91+92+92.1+92.2+96+96.5+99+100+101+102+103 一致), 3 文件 -25 行纯删除, 推翻 Sprint 52 commit 50eb241 拍板, 后端 /api/v1/visitor/* 100% 保留 (AudienceView 末尾访客段仍调 fetchVisitor* 不是 dead code, 留尾 #12 误判撤掉); v0.4.14.157 不变, pytest 819/23/0 持续, 累计 54 sprint 0 debt, L4.x **22 条 stable** 新增 L4.22 (前端 sprint 收口必 rebuild dist + restart vite preview, Sprint 104 close 实战补 Step 12.5/12.6 amend 闭环), 0 业务代码改动外的越界)
**当前债数**: 0 条 (留尾 #11 已由 Sprint 91 真修并经 Sprint 99/101 复验；L4.20 test 1 已由 Sprint 100 治根)
**跨 sprint 留尾**: 0 条 (Sprint 60+ 留尾 4 项闭环；D1 50m-scale 为按 30M 数据量触发的推后决策，不计当前债)
