...
### 修复方案
Sprint 24 P0-1 (commit d81148c): `_mark_all_files_processed()` 写 `cold_start_marked: False`. 新语义: **False = "已登记, 不触发重读"**; 真"需重读"由路径 A (新文件 / mtime 变化) 触发。
...
### 估时
已修复, Sprint 24 P0-1 收口 (v0.4.14.89)。
...
| 债 | 优先级 | 状态 | 估时 |
|---|---|---|---|
| #1 tracker JSON 设计缺陷 | P0 | ✅ 已修复 (v0.4.14.89) | - |
