...
**最后更新**: 2026-06-24 (Sprint 103 必修 1 修 DATA_PIPELINE.md 跨文档漂移 + L4.x 永久规则 21 stable 维护 (跟 STATUS.md line 81 同步 orders ~108GB + fact_rfm_long ~5GB + 索引 ~2GB)；v0.4.14.157 不变，pytest 819/23/0 持续，累计 53 sprint 0 debt，L4.x 21 条 stable，0 业务代码，0 新留尾)
