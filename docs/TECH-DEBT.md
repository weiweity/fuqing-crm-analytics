...
**最后更新**: 2026-07-02 (Sprint 191 — MCP stdio 协议 LSP → newline JSON 重写 + L4.44 永久规则. 累计 118 sprint 0 debt 持续 (跨 Sprint 60+ 0 debt stable 模式 +12 sprint), VERSION 0.4.14.33→**0.4.14.34** (Sprint 191 MCP stdio 协议 fix + 累计 22 次 /document-release 真治本, 跟 Sprint 179/181/182/183/184/185/186/187/188/190 模式 stable, 累计 13 次 /document-release bump 持续), L4.x 35→**36 stable** (新增 L4.44 MCP stdio 协议), fix_pattern #75 沉淀 (MCP stdio 协议混淆, 跟 fix_pattern #70/72 同位), 11 hook 闭环. 当前债数仍 0, 跨 sprint 留尾仍 0, 已修复累计 60+ 条)
