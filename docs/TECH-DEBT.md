...
**跨 sprint 留尾**: 1 条 (Sprint 90+: `test_ad_hoc_query.py::TestTakePathRules::test_build_take_path_cross_year_correct` hardcode `2026年6月22日` 期望, 但今天 `2026-06-23` 跨日 fail, 跟 L4.7 改动 100% 无关, 改为动态 `date.today().strftime("%Y年%m月%d日")` 防回归, 估时 半天)
