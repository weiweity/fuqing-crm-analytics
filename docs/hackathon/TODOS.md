...
- [ ] T17 剩余：系统目录选择器、PTC/Creator/自定义 preset、长会话/压缩及完整视觉；原生文件权限证据不代替业务撤权与真实数据/凭据可达边界。
- [x] 驾驶舱首屏精简、键盘详情、B0/比赛错误隔离和真实断连恢复已独立验证，见[本轮证据](PRODUCT-VISUAL-DENSITY-2026-09-10.md)。尚未切换 4325；其余技术文案和完整视觉仍开放。
