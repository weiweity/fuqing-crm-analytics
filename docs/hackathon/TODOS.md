...
### 2026-09-19 驾驶舱 V2（本地候选）

- [x] 接管 Grok G01–G04 累计未提交成果，仍在 codex/cockpit-v2-kernel / c0f47a24。
...
- [ ] 本次已授权 `/ship` 到提交、推送和 PR，按用户要求跳过追加代码审查；Git 结果待收尾同步。
- [ ] 现役切换仍需独立授权，真实模型/业务及用户 UAT 不代签。
