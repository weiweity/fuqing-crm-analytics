...
- [x] 本地清理：空闲树/已合分支已删；15173/8000 迁到 `main-runtime` 后拆 docs-155。原仓 `HANDOVER-CODEX.md` 保留。S4/S5 文档已写，G1–G6／U1 仍不勾选。
...
| S4 综合 QA | 候选钉死 `775934f5`／PID 12386；G2/G3 隔离 120+151+6 及加载插件 HTTP 集成通过；只读 v15/v9；G4/G5 壳层 PARTIAL。见 [S4](S4-QA-2026-09-15.md) | G1 本候选真模型；现场确认保存；G4 键盘／热插拔实点；完整 G5。不把探针当完整产品，不勾 G1–G5 |
| S5 交接入口 | 6677／15173／8000／18082 本轮探活；回退、合成范围、拒绝边界与三条 UAT 路径见 [S5](S5-UAT-HANDOVER-2026-09-15.md) | G6 待交接确认后勾选；U1 须本人；4325 历史入口不作当前交付 |
...
- [ ] T15：分析师 / 运营 / 老板完整流程，须用户本人验收。现役入口与三条路径见 [S5](S5-UAT-HANDOVER-2026-09-15.md)，不要用 4325。
