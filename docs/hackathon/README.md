...
最新开工约束：[视觉、Git/gstack、架构图与技术栈基线](./ENGINEERING-BASELINE-2026-09-05.md)。用户确认 **DSH 视觉优先，StaffDeck 为数字员工主参考**；已有目标架构图，新增布局组件仍待小样。D1–D4 方案已收口，下一步按原工作包补齐最小任务内核与 B0 硬门；原 B0 PARTIAL 状态不变，本次审核未扩大实施或发布授权。

执行历史：[B0本地DSH验证](./B0-DSH-VALIDATION-2026-09-05.md)、[worker/故障](./B0-WORKER-FAULT-VALIDATION-2026-09-06.md)与[监督器复查](./B0-SUPERVISOR-RECHECK-2026-09-06.md)保留各轮证据与失败。最新结果以本地收口报告为准；临时服务已全部停止。此前“实施未授权”为静态审查时记录；后续只授权 B0，不代表完整实现、付费模型或公网已授权。
