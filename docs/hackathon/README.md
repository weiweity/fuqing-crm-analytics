...
- [渠道首次观察队列共享 worker](./CHANNEL-FOLLOWUP-WORKER-2026-09-07.md)：G3b2 backend 共享 worker 合成查询；HTTP/native **NOT RUN**，G3 整体未完成；
