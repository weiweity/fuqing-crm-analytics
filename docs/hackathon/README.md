...
> **当前 Git／施工边界以仓库根 [STATUS.md](../../STATUS.md) 为准，接续任务见 [TODOS 的 M1 核心交付](TODOS.md#m1-核心交付)**。VERSION仍为0.8.0.0，产品PARTIAL。以下9月10日各轮的“当前／最新”、端口、SHA和授权是历史快照，不是现在的HEAD或新的操作授权；原失败证据保留。
