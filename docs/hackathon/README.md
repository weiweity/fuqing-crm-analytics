...
- [渠道首次观察队列受信 run 绑定](./CHANNEL-FOLLOWUP-RUN-BINDING-2026-09-07.md)：G3b1 单族 RunStore / 独立 query-run 合同；store-only，worker/native **NOT RUN**；
