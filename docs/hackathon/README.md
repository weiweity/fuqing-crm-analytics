...
**Git 收口（2026-09-08）**：`origin/main` = `225dc68`（#106）。#100 v0.6.0.0 查询资产驾驶舱、#102 v0.6.1.0 overlay 编译后 DOM、#103 v0.6.2.0 加入重试/不串板、#104 v0.6.3.0 首购离线金标准、#105/#106 hackathon README 收口已 squash 合入；#85–#99 依赖与 ruff 0.16.6（`lint.select` 仍为 0.15 的 `E4/E7/E9/F`）已合入。公网部署仍暂缓。产品仍 PARTIAL。
