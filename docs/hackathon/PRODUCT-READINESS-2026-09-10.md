...
> 当前增量：[S4 综合 QA](S4-QA-2026-09-15.md)固定候选 `775934f5`／6677 PID 12386，隔离 G2/G3 与加载插件 HTTP 主链通过，只读仍为说明板 v15／原板 v9；[S5 入口与 G6 清单](S5-UAT-HANDOVER-2026-09-15.md)指向 6677／15173。G1 本候选真模型 NOT_RUN。不勾 G1–G6，不代签 UAT。
