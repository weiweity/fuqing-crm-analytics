...
最新独立增量：[看板候选与真实评测](PRODUCT-UAT-CANDIDATE-2026-09-10.md)已切换 4325，`cde6a81` CI SUCCESS；两种问法均算出 410/305，但来源标识混用，T13 仍 PARTIAL。方法修正通过完整 B0，尚未进入候选或真实复测；用户本人 T15 等门禁仍开放。
