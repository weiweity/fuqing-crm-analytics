...
本地代码与回归已完成；`84b0ac8` [CI 34441966415](https://github.com/weiweity/fuqing-crm-analytics/actions/runs/34441966415) SUCCESS，已切换 4325/18083。后续[候选与真实复测](COMPUTED-UNITS-CANDIDATE-2026-09-10.md)补齐五库恢复、原生单位展示及三条有界 DeepSeek 用例；完整 T13/T15/T16/T17 与产品仍 PARTIAL。
...
上述检查、远端 CI、候选切换和有界真实复测现已完成，具体时点和局部验收边界见当前候选记录。用户业务口、归档大库和模型凭据保持原状；本地验收不代表公网发布或本人 T15 签字。
