...
分支 `codex/fix-local-demo-startup` 基于 `origin/main@89d3423`，本文提交后共有 12 个本地提交，未 push、未建 PR、未部署。
...
- 本分支 12 个本地提交尚未进入远端，因此上述绿色记录不能替代本分支提交前验证。
...
| 2 | 本地分支最终评审 | 对 12 个本地提交做一次提交前 diff 审查 | 下一步 |
