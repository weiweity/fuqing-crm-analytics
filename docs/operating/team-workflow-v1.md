...
## 6. 后续 backlog（hygiene 之后）

1. STATUS.md 截断为短表（长文迁 history）
2. CI branch protection：required = lint + test only
3. 非生产预发环境（schema / 抽样数据）
4. CLAUDE L4.1–62 表继续下沉 `docs/rules/`
5. e2e 修稳或正式 nightly-only
