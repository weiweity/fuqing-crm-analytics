...
> **最后更新**: 2026-07-26
> 历史背景为「本地即生产 + AI 协作者」；当前已归档，以下流程不是默认执行清单。
> **2026-09-06**：行为与授权只按 [AGENTS.md](../../AGENTS.md)。本文件的 CI/协作分层供按需参考，不能覆盖当前边界或自动触发 push、merge、重启；具体 required checks 以实际配置与运行证据为准。
