...
| 指标 | 7/3 baseline (L4.54 落地前) | 7/4 R1 (L4.54 落地, 0 实质效果) | 期望 (R4 修后) |
|---|---|---|---|
| **wall_min (W6 通知)** | 33.7 min | 63.0 min | **<15 min** (跟 R1 跑批 7/3 baseline + L4.54 优化 1+2 期望 1:1 stable) |
| **Step 4.7 is_member 标** | 5,702,274 单 | 5,703,316 单 | 5,703,316 单 (跟 R1 1:1 stable, R4 修后真子集而非全表) |
