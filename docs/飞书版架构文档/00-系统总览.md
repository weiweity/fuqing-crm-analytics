...
**版本**: v5.2（2026-06-06 更新 — 刷 W2/W3/W4 + CI 6 件套）
**状态**: 语义层 ✅ | 契约层 ✅ | 服务层 ✅ | 前端 Vue3 ✅ | 老客健康分析 ✅ | 配置扩展 P1-P4 ✅ | 重构 Phase 0-7 ✅ | Docker 化 ✅ | RFM 缓存修复 ✅ | 代码审计 ✅ | 大文件拆分 ✅ | **W2 manifest 原子切换 ✅ (v0.4.8)** | **W3 DQ 断言 MVP ✅ (v0.4.10)** | **W4 fact_rfm_long ✅ (v0.4.9)** | **CI 6 件套 5/6 ✅ (B2-B6 done, B1 待)**
