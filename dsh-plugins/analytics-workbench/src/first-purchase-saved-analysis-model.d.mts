...
export type SavedAnalysisViewModel = Base & (
  ...
  { kind: 'detail'; title: string; badge: string; version: number; condition: string; totals: string; empty: EmptyReason; evidence: string; joinHint: string; synthetic: string; saveState: 'idle' | 'saved' } |
...
export function decodeSavedAnalysis(value: unknown): unknown;
export function decodeSavedAnalysisList(value: unknown): unknown;
export function isForeignFamily(value: unknown): boolean;
export function renderSavedAnalysisHtml(view: SavedAnalysisViewModel): string;
