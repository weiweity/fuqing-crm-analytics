...
import { COPY, buildSavedAnalysisView } from './first-purchase-saved-analysis-model.mjs';
...
export function FirstPurchaseSavedAnalysisView(props: SavedAnalysisViewProps) {
  ...
  return <>
    <style>{css}</style>
    <div className="analytics-b0-dialog analytics-saved-analysis" data-testid="analytics-first-purchase-saved-analysis-view"
      ...
      {view.kind === 'empty' && <p data-testid="analytics-first-purchase-saved-analysis-empty">{view.message}</p>}
      {view.kind === 'list' && view.items && <ul data-testid="analytics-first-purchase-saved-analysis-list">
