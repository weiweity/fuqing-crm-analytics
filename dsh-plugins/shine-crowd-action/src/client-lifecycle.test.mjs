/** Client apply sets the pack flag. Not a native Settings enable/disable run. */
...
test('apply marks the crowd-action pack present', () => {
  const { client, sandbox } = loadClient();
  client.apply({});
  assert.equal(sandbox.__SHINE_CROWD_ACTION__, true);
});
