...
- ✅ 测试 819 passed / 23 skipped (本地 macOS Sprint 99 收口) + Vite build 0 错误 + e2e 12/12 PASS + SQL f-string lint 0 violations + L3 FilterBuilder 14/14 service 100% 闭环 + L4.20 close-memory SSOT 漂移 lint 跑通 (v0.4.14.157, Sprint 99 收口; 累计 Sprint 34.1+36.4+50+50.1+53+53.5+54 共同构成 AI write safety net + Sprint 60+60.1+60.1.1+60.2 500 错误治根 + Sprint 61 P2 fail-fast + Sprint 62 /ad-hoc-query 3 子命令 + Sprint 62.5 4 项磁盘清理治根 (169GB→95GB+53GB 释放) + Sprint 63 CI 维修 + Sprint 64 ruff-action v4 revert + Sprint 66 CI 维修 P0+P1 + housekeeping 3 类清理 + Sprint 67+68 留尾 SSOT 治理 (L4.12 永久规则) + Sprint 69 MEMORY dedupe + Sprint 70-88 累计 19 sprint 0 业务代码反思 + Sprint 89 暂收口 + Sprint 90 L4.7 ground-truth-lint + Sprint 91 必修 4 闭环留尾治理 sprint 模式 + Sprint 92+92.1+92.2 L4.9 实战 fix 模式 + Sprint 93 必修 1 真业务 sprint + Sprint 94 /document-release 验证 5/5 + Sprint 95+96+96.1+96.2+96.3+96.4+96.5 7 sprint 完整链路 D2 e2e 50+MB OOM 治本真因真发现实战 fix 模式 + Sprint 97 FilterBuilder 治标推广 12 service (Sprint 60+ 留尾 #1) + Sprint 98 FilterBuilder 真治本 OrderFilters.channel_in/not_in 加 table_alias 参数 + FilterBuilder 加 self._table_alias + with_table_alias() + 删全 12 service 14 处 .replace() 重复代码 + Codex 主动 audit 补 7 service 单表 SQL orders o 别名 + Sprint 99 留尾 #11 SSOT 漂移闭环 + L4.20 反 SSOT 漂移永久规则根治 + check_ssot_drift.py ground-truth-lint + 4 case regression test + Sprint 60+ 留尾 5 项 → 4 闭环 + 1 推后 (D1 50m-scale 待 30M 触发), 累计 Sprint 56+60+60.1+60.1.1+60.2+61+62+62.5+63+64+65+66+67+68+69+70+71+72+73+74+75+76+77+78+79+80+81+82+83+84+85+86+87+88+89+90+91+92+92.1+92.2+93+94+95+96+96.1+96.2+96.3+96.4+96.5+97+98+99 = **49 sprint 0 debt 持续**, L4.x 永久规则 20 条 stable (L4.20 反 SSOT 漂移永久规则新增))
...
| [CHANGELOG.md](./CHANGELOG.md) | 版本变更记录 (v0.4.14.157, Sprint 99 收口) |
...
当前测试覆盖（**819 passed / 23 skipped**，Sprint 99 收口，v0.4.14.157；Sprint 98 baseline 815 passed / 23 skipped；本地 macOS 持续）：
