...
| 2026-06-30 | **Sprint 169 收口** (02 板块回购周期分布率最终收口 + worktree uvicorn 启动脚本 + W3 DQ/test fix + 复购周期 endpoint bug fix '全店' sentinel 守卫, v0.4.14.21 跨 66 sprint 不 bump stable, 累计 96→98 0 debt sprint 持续) |
| 2026-06-30 | **Sprint 170 收口** (RFM 8 象限 → R 区间 6 桶业务口径变更, `backend/semantic/segments.py:R_SEGMENT_ORDER` 公共 SSOT 沉淀, 11 service 同步 + e2e/spec drift 治根 18 sprint 滞后 stable 模式 (L4.23 永久规则) + 检测脚本自动化, v0.4.14.21) |
