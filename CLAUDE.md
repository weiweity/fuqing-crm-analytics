...
| 4 | **版本状态** | v0.4.14.41 — 详见 `git log --oneline \| head -5` 和 `CHANGELOG.md` |
...
## L4.x 永久规则 → `docs/rules/L4-permanent-rules.md`

> 详细记录（L4.63-L4.91 真根因、强契约、反模式清单）已移至 `docs/rules/L4-permanent-rules.md`。
> 摘要索引见上方「Typo 防御表」（L4.1-L5.2）。
> 按需加载：`Read docs/rules/L4-permanent-rules.md`
