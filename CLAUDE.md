...
| 4 | **版本状态** | v0.4.14.35（main @ 9de096e + Sprint 197 R1 + Sprint 198 R1 拍板 D + 选项 3 真治本: 立 ad-hoc-query 第 13/14 个 tool `fixed-product-list-compare-http` 走 HTTP API + `ai-sandbox-execute` 走 sandbox backend service + audit log: 11 files / +273/-26 across 1 commit, 0 业务代码改动 (跟 Sprint 89/167/190/191/192/193/194/195/196 模式 stable, 累计 18 次 /document-release bump 持续), L4.x 38→**38 stable** (Sprint 197/198 0 新增, 跟 L4.5/L4.20/L4.36/L4.37/L4.38/L4.41/L4.46 + fix_pattern #81/#82 stable 配套), fix_pattern #82 沉淀 (任何 ad-hoc-query 工具收口必走两步走, 跟 Sprint 195 R1 duckdb 不做功能新增 拍板冲突, 用户真业务触发重新拍板). 累计 124 sprint 0 debt 持续 (跨 Sprint 60+ 0 debt stable 模式 +19 sprint), /document-release 累计 28 次. pytest baseline 962/73/0 → **971/73/0** (净 +9 case 真跑, Sprint 197 R1 5 case + Sprint 198 R1 5 case, 跨 sprint 关键定向 18 case). SKILL.md v2.4 → **v2.6** 升级 (L4.35 symlink 跨端 1 份, 12 tool → 14 tool + §0.4 段 Sprint 197 治本 + §0.5 段 Sprint 198 治本). |
