...
| 4 | **版本状态** | v0.4.14.35（main @ baf7cae + Sprint 196 — Sprint 195 plan-eng-review B 治本: 立 ad-hoc-query 第 12 个 tool `fixed-product-list-compare` + 复用 backend/services SSOT + 60+ product_id 固定清单 + fix_pattern #82: 12 files / +546/-55 across 2 commit, 0 业务代码改动 (跟 Sprint 89/167/190/191/192/193/194/195 模式 stable, 累计 17 次 /document-release bump 持续), L4.x 38→**38 stable** (Sprint 196 0 新增, 跟 L4.5/L4.20/L4.36/L4.37/L4.38/L4.41/L4.46 stable 配套), fix_pattern #82 (任何 ad-hoc-query 工具收口必走两步走 — 禁临时脚本同时立刻补 backend services 拼凑 tool 或 export_excel 11 sheet 覆盖) 沉淀. 累计 122 sprint 0 debt 持续 (跨 Sprint 60+ 0 debt stable 模式 +16 sprint), /document-release 累计 27 次. pytest baseline 957/73/0 → **962/73/0** (净 +5 case 真跑, Sprint 196 R1 5 case 跟 Sprint 195 R1 fix_pattern #81 配套). SKILL.md v2.3 → **v2.4** 升级 (L4.35 symlink 跨端 1 份, 11 tool → 12 tool). |
