...
- Git 合入不等于部署。6677 原仓 runtime PID **81447** 已 remainder start（shine-brand boot 已合 #205）。15173 PID **85899**、8000 PID **85883**、18082 PID **83173** 未动。现役未 `--fresh`。不要用会编原仓插件的官方 `reload`。工作树已收口，只留 `main`。
