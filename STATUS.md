...
| 项 | 状态 |
|---|---|
| VERSION / main | VERSION **0.9.0.5**。origin/main **`021ffe0b`**（#198）。loopback。**不上公网**。产品仍 PARTIAL。 |
...
- `HANDOVER-CODEX.md` 不提交。下一产品：问数／组板另授权、公网另授权。人群行动已合 #198。WATERFALL 已合 #196。品牌已合 #194。#171 `5a8329c3`。Q3 overlay 已灌；`fill_user_rfm=0`。
