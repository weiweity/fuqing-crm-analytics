...
| 项 | 状态 |
|---|---|
| VERSION / main | VERSION **0.8.0.1**（人群行动入口）；非正式 release。origin/main 合入前为 `35a79585`（#164）。实际 HEAD 用 `git log -1` 核对 |
