...
| **main** | `origin/main`（#30–#35：hooks / hygiene / TECH-DEBT / STATUS 短表 / e2e soft） |
| **分支** | 目标仅 `main`；feature 合完即删 |
| **可合并 CI** | lint + test 必绿；e2e `continue-on-error`（`team-workflow-v1`） |
| **债** | [`docs/TECH-DEBT.md`](docs/TECH-DEBT.md) 短表；编年见 `docs/history/` |
| **文档入口** | [`docs/README.md`](docs/README.md) · 工作区 [`../README.md`](../README.md) |
