...
| 项 | 状态 |
|---|---|
| VERSION / main | `0.7.0.0`。HEAD 以 `git log -1` 为准；已合 #112、#114、#115、**#116–#119**（#119 = `4daa3b4`） |
...
| 5 | GSV 口径谓词 SSOT | 归档 `archive/2026-09-11-iron-rules-t4` | **下一刀**（说「开 GSV」） |
| 6 | DQ 本地告警（不接飞书） | 同一归档 | 其后 |
| 7 | T13 可重放离线 eval | 同一归档 | 其后；不代替真实模型复测 |
...
- GSV / DQ / T13 eval / 驾驶舱 WIP 在上表对应归档分支，**未合进 main 前不要从别的刀顺手捡**
