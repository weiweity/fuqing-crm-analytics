...
| 项 | 状态 |
|---|---|
| VERSION / main | VERSION **0.9.0.8**。origin/main **`7a465316`**（#207）。loopback。**不上公网**。产品仍 PARTIAL。 |
...
- Git 合入不等于部署。#207 `7a465316` 已合；6677 未因该合入 reload。原仓 remainder PID **81447**（#205 boot）。15173 PID **85899**、8000 PID **85883**、18082 PID **83173** 未动。现役未 `--fresh`。不要用会编原仓插件的官方 `reload`。
- `HANDOVER-CODEX.md` 不提交。下一产品：公网另授权。比赛看板保持 15173 独立，不进 DSH。shine-brand boot 已合 #205。FUNNEL 已合 #202。问数／组板已合 #200。人群行动已合 #198。WATERFALL 已合 #196。品牌已合 #194。#171 `5a8329c3`。Q3 overlay 已灌；`fill_user_rfm=0`。
