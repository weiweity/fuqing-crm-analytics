...
| 项 | 状态 |
|---|---|
| VERSION / main | VERSION **0.9.0.2**。origin/main **`34e0ebef`**（#184）。loopback。**不上公网**。产品仍 PARTIAL。 |
...
| T15 / T16 / T17 | T15 本人「通过」。T16 合成基线已记、未当 SLO。T17 本候选收口：视口／Stop／compact／a11y 已取证；真机／18084 全路径／DSH 稿用户确认缺口也算关 |
