...
const CHANNEL_ORDER = [
  '货架', '达播', '直播', 'affiliate', '微博', 'U先派样', '百补派样', '赠品&0.01', '其他',
]
...
const indicatorColumns = computed<DataTableColumns<IndicatorRow>>(() => {
  ...
  cols.push({
    ...
    width: 120,
    align: 'center',
    render: (row: IndicatorRow) => h(YOYGuard, { value: row.yoy, unit: row.kind === 'ratio' ? 'pp' : '%', styled: true}),
  })
  return cols
})
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        render: (row: ChannelGSVRow) => h(YOYGuard, { value: (row.yoy ?? 0), unit: '%', styled: true}),
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        render: (row: ChannelGSVRow) => h(YOYGuard, { value: (row.users_yoy ?? 0), unit: '%', styled: true}),
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        render: (row: ChannelGSVRow) => h(YOYGuard, { value: (row.aus_yoy ?? 0), unit: '%', styled: true}),
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        render: (row: ChannelGSVRow) => h(YOYGuard, { value: (row.new_gsv_yoy ?? 0), unit: '%', styled: true}),
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        render: (row: ChannelGSVRow) => h(YOYGuard, { value: (row.new_gsv_ratio_yoy ?? 0), unit: 'pp', styled: true}),
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        render: (row: ChannelGSVRow) => h(YOYGuard, { value: (row.new_users_yoy ?? 0), unit: '%', styled: true}),
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        render: (row: ChannelGSVRow) => h(YOYGuard, { value: (row.new_aus_yoy ?? 0), unit: '%', styled: true}),
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        render: (row: ChannelGSVRow) => h(YOYGuard, { value: (row.old_gsv_yoy ?? 0), unit: '%', styled: true}),
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        render: (row: ChannelGSVRow) => h(YOYGuard, { value: (row.old_gsv_ratio_yoy ?? 0), unit: 'pp', styled: true}),
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        render: (row: ChannelGSVRow) => h(YOYGuard, { value: (row.old_users_yoy ?? 0), unit: '%', styled: true}),
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        render: (row: ChannelGSVRow) => h(YOYGuard, { value: (row.old_aus_yoy ?? 0), unit: '%', styled: true}),
      },
    ],
  },
]})
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        render: (row: ChannelGSVRow) => h(YOYGuard, { value: (row.member_ratio_yoy ?? 0), unit: 'pp', styled: true}),
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        render: (row: ChannelGSVRow) => h(YOYGuard, { value: (row.member_new_vs_all_new_yoy ?? 0), unit: 'pp', styled: true}),
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        render: (row: ChannelGSVRow) => h(YOYGuard, { value: (row.member_old_vs_all_old_yoy ?? 0), unit: 'pp', styled: true}),
      },
    ],
  },
]})
  ...
  return [
    { title: '渠道', key: 'channel', width: 110, fixed: 'left', align: 'center', sorter: false },
    {
      ...
      children: [
        ...
        { title: yoyLabel, key: 'yoy', width: 90, align: 'center', sorter: (a: ChannelGSVRow, b: ChannelGSVRow) => (a.yoy ?? 0) - (b.yoy ?? 0), render: (row: ChannelGSVRow) => h(YOYGuard, { value: (row.yoy ?? 0), unit: '%', styled: true}) },
      ],
    },
    {
      ...
      children: addChannelGroupSep([
        ...
        { title: yoyLabel, key: 'new_gsv_yoy', width: 90, align: 'center', sorter: (a: ChannelGSVRow, b: ChannelGSVRow) => (a.new_gsv_yoy ?? 0) - (b.new_gsv_yoy ?? 0), render: (row: ChannelGSVRow) => h(YOYGuard, { value: (row.new_gsv_yoy ?? 0), unit: '%', styled: true}) },
    ...
    },
    {
      ...
      children: addChannelGroupSep([
        ...
        { title: yoyLabel, key: 'old_gsv_yoy', width: 90, align: 'center', sorter: (a: ChannelGSVRow, b: ChannelGSVRow) => (a.old_gsv_yoy ?? 0) - (b.old_gsv_yoy ?? 0), render: (row: ChannelGSVRow) => h(YOYGuard, { value: (row.old_gsv_yoy ?? 0), unit: '%', styled: true}) },
  ...
  return [
    ...
    },
    {
      ...
      children: [
        ...
        { title: yoyLabel, key: 'member_ratio_yoy', width: 90, align: 'center', sorter: (a: ChannelGSVRow, b: ChannelGSVRow) => (a.member_ratio_yoy ?? 0) - (b.member_ratio_yoy ?? 0), render: (row: ChannelGSVRow) => h(YOYGuard, { value: (row.member_ratio_yoy ?? 0), unit: 'pp', styled: true}) },
      ],
    },
  ]
})
