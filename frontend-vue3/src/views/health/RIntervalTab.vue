...
const rFlowColumns = computed<DataTableColumns<RFMRFlowRow>>(() => {
  ...
  return [
    ...
    },
    {
      ...
      width: 110,
      align: 'center',
      render: (r: RFMRFlowRow) => h(YOYBadge, { value: r.yoy_hist_users }),
    },
    {
      title: `${yr}年同比人数`,
      ...
      width: 110,
      align: 'center',
      render: (r: RFMRFlowRow) => h(YOYBadge, { value: r.yoy_repurchase_users }),
    },
    {
      title: `${yr}同比回购率`,
      ...
      width: 110,
      align: 'center',
      render: (r: RFMRFlowRow) => h(YOYBadge, { value: r.yoy_repurchase_rate, unit: 'pp' }),
    },
    {
      title: `${yr}同比回购GSV`,
      ...
      width: 110,
      align: 'center',
      render: (r: RFMRFlowRow) => h(YOYBadge, { value: r.yoy_repurchase_gsv }),
    },
    {
      title: `${yr}同比回购GSV占比`,
      ...
      width: 110,
      align: 'center',
      render: (r: RFMRFlowRow) => h(YOYBadge, { value: r.yoy_repurchase_gsv_ratio_ppt, unit: 'pp' }),
    },
