...
const fFlowColumns = computed<DataTableColumns<RFMFRFlowRow>>(() => {
  ...
  return [
    ...
    },
    {
      ...
      width: 110,
      align: 'center',
      render: (r: RFMFRFlowRow) => h(YOYGuard, { value: r.yoy_hist_users, styled: true}),
    },
    {
      title: `${yr}年同比人数`,
      ...
      width: 110,
      align: 'center',
      render: (r: RFMFRFlowRow) => h(YOYGuard, { value: r.yoy_repurchase_users, styled: true}),
    },
    {
      title: `${yr}同比回购率`,
      ...
      width: 110,
      align: 'center',
      render: (r: RFMFRFlowRow) => h(YOYGuard, { value: r.yoy_repurchase_rate, unit: 'pp', styled: true}),
    },
    {
      title: `${yr}同比回购GSV`,
      ...
      width: 110,
      align: 'center',
      render: (r: RFMFRFlowRow) => h(YOYGuard, { value: r.yoy_repurchase_gsv, styled: true}),
    },
    {
      title: `${yr}同比回购GSV占比`,
      ...
      width: 110,
      align: 'center',
      render: (r: RFMFRFlowRow) => h(YOYGuard, { value: r.yoy_repurchase_gsv_ratio_ppt, unit: 'pp', styled: true}),
    },
