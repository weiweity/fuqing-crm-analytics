  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        render: (row: ChannelGSVRow) => h(YOYBadge, { value: row.new_gsv_ratio_yoy, unit: 'pp' }),
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        render: (row: ChannelGSVRow) => h(YOYBadge, { value: row.old_gsv_ratio_yoy, unit: 'pp' }),
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        render: (row: ChannelGSVRow) => h(YOYBadge, { value: row.member_ratio_yoy, unit: 'pp' }),
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        render: (row: ChannelGSVRow) => h(YOYBadge, { value: row.member_new_vs_all_new_yoy, unit: 'pp' }),
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        render: (row: ChannelGSVRow) => h(YOYBadge, { value: row.member_old_vs_all_old_yoy, unit: 'pp' }),
      },
    ],
  },
]})
  ...
  return [
    ...
    },
    {
      ...
      children: [
        ...
        { title: yoyLabel, key: 'member_ratio_yoy', width: 90, align: 'center', sorter: (a: ChannelGSVRow, b: ChannelGSVRow) => (a.member_ratio_yoy ?? 0) - (b.member_ratio_yoy ?? 0), render: (row: ChannelGSVRow) => h(YOYBadge, { value: row.member_ratio_yoy, unit: 'pp' }) },
      ],
    },
  ]
})
