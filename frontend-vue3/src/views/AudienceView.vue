  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        render: (row: ChannelGSVRow) => h(YOYBadge, { value: (row.yoy ?? 0), unit: '%' }),
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        render: (row: ChannelGSVRow) => h(YOYBadge, { value: (row.users_yoy ?? 0), unit: '%' }),
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        render: (row: ChannelGSVRow) => h(YOYBadge, { value: (row.aus_yoy ?? 0), unit: '%' }),
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        render: (row: ChannelGSVRow) => h(YOYBadge, { value: (row.new_gsv_yoy ?? 0), unit: '%' }),
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        render: (row: ChannelGSVRow) => h(YOYBadge, { value: (row.new_users_yoy ?? 0), unit: '%' }),
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        render: (row: ChannelGSVRow) => h(YOYBadge, { value: (row.new_aus_yoy ?? 0), unit: '%' }),
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        render: (row: ChannelGSVRow) => h(YOYBadge, { value: (row.old_gsv_yoy ?? 0), unit: '%' }),
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        render: (row: ChannelGSVRow) => h(YOYBadge, { value: (row.old_users_yoy ?? 0), unit: '%' }),
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        render: (row: ChannelGSVRow) => h(YOYBadge, { value: (row.old_aus_yoy ?? 0), unit: '%' }),
      },
    ],
  },
]})
  ...
  return [
    { title: '渠道', key: 'channel', width: 110, fixed: 'left', align: 'center', sorter: false },
    {
      ...
      children: [
        ...
        { title: yoyLabel, key: 'yoy', width: 90, align: 'center', sorter: (a: ChannelGSVRow, b: ChannelGSVRow) => (a.yoy ?? 0) - (b.yoy ?? 0), render: (row: ChannelGSVRow) => h(YOYBadge, { value: (row.yoy ?? 0), unit: '%' }) },
      ],
    },
    {
