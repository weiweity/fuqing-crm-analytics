...
Covers the MCP server wrapper around scripts/ad_hoc_query.py:
  - 14 MCP tools (13 query + 1 ask), exposed via list_tools()
...
class TestMcpServerImport:
    ...
    def test_list_tools_returns_14_tools(self):
        """list_tools() MUST return exactly 14 tools (13 query + 1 ask).

        目的: 锁 Sprint 182 + Sprint 183 + Sprint 196-198 列出的 14 tool 数量. 任何后续添加新 tool
        ...
        assert len(tools) == EXPECTED_TOOL_COUNT, (
            f"期望 {EXPECTED_TOOL_COUNT} tools (13 query + 1 ask), "
