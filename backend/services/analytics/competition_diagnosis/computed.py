...
from backend.contracts.competition_computed import (
    ...
    MAX_CHANNEL_CONTRIBUTIONS, CompetitionGsvFactsV5, GsvChannelBridge, GsvDailySeries, GsvPeriodFacts, GsvPeriodFactsV5,
...
def _channel_bridge(connection, periods, orders_by_period, money_unit) -> GsvChannelBridge:
