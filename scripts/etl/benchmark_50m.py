#!/usr/bin/env python3
"""
benchmark_50m.py — 从现有 fuqing_crm.duckdb 采样分布，生成 50M 行模拟订单数据。
...
输出：data/processed/fuqing_crm_50m.duckdb（不修改原始数据库）
"""
...
SRC_DB = ROOT / "data" / "processed" / "fuqing_crm.duckdb"
DST_DB = ROOT / "data" / "processed" / "fuqing_crm_50m.duckdb"
